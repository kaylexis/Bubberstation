...
/obj/structure/bloodsucker/bloodthrone
	...
	icon = 'modular_zubbers/code/modules/antagonists/bloodsuckers/icons/vamp_obj_64.dmi'
	icon_state = "throne"
	buckle_lying = 0
	anchored = FALSE
	density = TRUE
...
/obj/structure/bloodsucker/bloodthrone/proc/GetArmrest()
	return mutable_appearance('modular_zubbers/code/modules/antagonists/bloodsuckers/icons/vamp_obj_64.dmi', "thronearm")
