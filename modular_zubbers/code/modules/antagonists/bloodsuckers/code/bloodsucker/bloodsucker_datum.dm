/datum/antagonist/bloodsucker
	...
	hijack_speed = 0.5
	hud_icon = 'modular_zubbers/code/modules/antagonists/bloodsuckers/icons/bloodsucker_icons.dmi'
...
/datum/antagonist/bloodsucker/greet()
	...
	owner.current.playsound_local(null, 'modular_zubbers/code/modules/antagonists/bloodsuckers/sounds/BloodsuckerAlert.ogg', 100, FALSE, pressure_affected = FALSE)
