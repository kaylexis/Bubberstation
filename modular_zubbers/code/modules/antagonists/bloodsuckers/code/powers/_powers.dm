/datum/action/cooldown/bloodsucker
	...
	background_icon = 'modular_zubbers/code/modules/antagonists/bloodsuckers/icons/actions_bloodsucker.dmi'
	background_icon_state = "vamp_power_off"
	button_icon = 'modular_zubbers/code/modules/antagonists/bloodsuckers/icons/actions_bloodsucker.dmi'
